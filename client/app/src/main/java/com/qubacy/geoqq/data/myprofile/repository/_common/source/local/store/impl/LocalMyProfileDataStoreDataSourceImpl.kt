package com.qubacy.geoqq.data.myprofile.repository._common.source.local.store.impl
...
class LocalMyProfileDataStoreDataSourceImpl @Inject constructor(
    ...
    override suspend fun getMyProfile(): MyProfileDataStoreModel? {
    ...
    override suspend fun saveMyProfile(myProfile: MyProfileDataStoreModel) {
    ...
    override suspend fun resetMyProfile() {
        mMyProfileDataStore.edit {
            it.clear()
        }
    }
