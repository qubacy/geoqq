package com.qubacy.geoqq.data._common.repository._common.source.remote.http.websocket.event.server.payload.error.json.adapter
...
class ErrorServerEventPayloadJsonAdapter(
    ...
    override fun fromJson(p0: JsonReader): ErrorServerEventPayload? {
        ...
        return ErrorServerEventPayload(code!!, error)
    }

    override fun toJson(p0: JsonWriter, p1: ErrorServerEventPayload?) {
