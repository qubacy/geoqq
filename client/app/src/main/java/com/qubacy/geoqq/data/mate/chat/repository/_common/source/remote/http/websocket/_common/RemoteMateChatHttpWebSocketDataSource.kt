package com.qubacy.geoqq.data.mate.chat.repository._common.source.remote.http.websocket._common
...
abstract class RemoteMateChatHttpWebSocketDataSource @OptIn(ExperimentalCoroutinesApi::class) constructor(
