...
class MyProfileDataRepositoryImplTest(

) : DataRepositoryTest<MyProfileDataRepositoryImpl>() {
    companion object {
        val DEFAULT_AVATAR = MyProfileDataRepositoryTestContext.DEFAULT_AVATAR

        val DEFAULT_GET_MY_PROFILE_RESPONSE = MyProfileDataRepositoryTestContext
            .DEFAULT_GET_MY_PROFILE_RESPONSE

        val DEFAULT_DATA_MY_PROFILE = MyProfileDataRepositoryTestContext.DEFAULT_DATA_MY_PROFILE
        val DEFAULT_DATA_MY_PROFILE_UPDATE_DATA = MyProfileDataRepositoryTestContext
            .DEFAULT_DATA_MY_PROFILE_UPDATE_DATA
    }
    ...
    private fun mockLocalMyProfileDataSource(): LocalMyProfileDataStoreDataSource {
        val localMyProfileDataSourceMock = Mockito.mock(LocalMyProfileDataStoreDataSource::class.java)
    ...
    private fun mockHttpMyProfileDataSource(): RemoteMyProfileHttpRestDataSource {
        val httpMyProfileDataSourceMock = Mockito.mock(RemoteMyProfileHttpRestDataSource::class.java)
    ...
    fun getMyProfileWithNoLocalDataTest() = runTest {
        ...
        val getMyProfileResponse = DEFAULT_GET_MY_PROFILE_RESPONSE
    ...
    fun updateMyProfileWithoutAvatarTest() = runTest {
        val myProfileUpdateData = DEFAULT_DATA_MY_PROFILE_UPDATE_DATA.copy(avatarUri = null)
