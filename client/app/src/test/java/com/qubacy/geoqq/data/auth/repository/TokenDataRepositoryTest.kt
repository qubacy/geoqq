...
import com.qubacy.geoqq.data.auth.repository.source.local.store.LocalStoreTokenDataSource
...
class TokenDataRepositoryTest : DataRepositoryTest<AuthDataRepository>() {
    companion object {
    ...
    private fun initTokenDataRepository() = runTest {
        ...
        val localDatabaseTokenDataSourceMock = Mockito.mock(LocalAuthDatabaseDataSource::class.java)
        ...
        val httpTokenDataSourceMock = Mockito.mock(HttpAuthDataSourceApi::class.java)
