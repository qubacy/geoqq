...
import (
	...
	avatarImpl "geoqq_http/pkg/avatar/impl"
	"geoqq_http/pkg/cache"
	redisCache "geoqq_http/pkg/cache/redisCache"
	geoDistanceImpl "geoqq_http/pkg/geoDistance/impl/haversine"
	"geoqq_http/pkg/hash"
	hashImpl "geoqq_http/pkg/hash/impl"
	"geoqq_http/pkg/logger"
	"geoqq_http/pkg/logger/impl"
	"geoqq_http/pkg/token"
	tokenImpl "geoqq_http/pkg/token/impl"
